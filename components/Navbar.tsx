  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full mt-4 px-6">
      <div className="flex w-full items-center justify-between">
        <div className="text-2xl font-bold ml-10">Pun.dev</div>

        <div className="flex items-center gap-4 mr-10">
          <NavigationMenu delayDuration={0}>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-0.75xl">
                  Home
                </NavigationMenuTrigger>
                <NavigationMenuContent>
          ...
          <Link
            href="/my-projects"
            className="text-0.75xl font-medium transition-colors hover:bg-secondary px-4 py-2 rounded-lg"
          >
